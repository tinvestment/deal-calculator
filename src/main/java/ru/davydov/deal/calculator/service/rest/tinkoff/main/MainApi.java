package ru.davydov.deal.calculator.service.rest.tinkoff.main;
...
public interface MainApi {
    ...
    class Configuration {
        @Bean
        public Logger.Level level(@Value("${rest.tinkoff-main-api.logger-level:BASIC}") Logger.Level level) {
            return level;
        }
